...
int distribute(void)
{
  ...
  my_fft_box[0] = MyGrids[0].GSstart_x;
  my_fft_box[1] = MyGrids[0].GSstart_y;
  my_fft_box[2] = MyGrids[0].GSstart_z;
  my_fft_box[3] = MyGrids[0].GSlocal_x;
  my_fft_box[4] = MyGrids[0].GSlocal_y;
  my_fft_box[5] = MyGrids[0].GSlocal_z;
...
int intersection(int *fbox, int *sbox, int *ibox)
{
  ...
  Lbox[0]=MyGrids[0].GSglobal_x;
  Lbox[1]=MyGrids[0].GSglobal_y;
  Lbox[2]=MyGrids[0].GSglobal_z;
...
unsigned int fft_space_index(unsigned int pos, int *box)
{
  ...
  */
  ...
  return ( (ip + box[0]) % MyGrids[0].GSglobal_x - MyGrids[0].GSstart_x) + (MyGrids[0].GSlocal_x) * 
    ( ( (jp + box[1]) % MyGrids[0].GSglobal_y - MyGrids[0].GSstart_y) 
      + ( (kp + box[2]) % MyGrids[0].GSglobal_z - MyGrids[0].GSstart_z) * MyGrids[0].GSlocal_y);
}
...
unsigned int subbox_space_index(unsigned int pos, int *box)
{
  ...
  int sub_x = ((ip + box[0])%MyGrids[0].GSglobal_x - subbox.stabl_x + MyGrids[0].GSglobal_x)%MyGrids[0].GSglobal_x;
  int sub_y = ((jp + box[1])%MyGrids[0].GSglobal_y - subbox.stabl_y + MyGrids[0].GSglobal_y)%MyGrids[0].GSglobal_y;
  int sub_z = ((kp + box[2])%MyGrids[0].GSglobal_z - subbox.stabl_z + MyGrids[0].GSglobal_z)%MyGrids[0].GSglobal_z;
